        ...
        function GoCart(t) {
          ...
          (this.defaults = Object.assign(
            {},
            {
              ...
              labelCartIsEmpty: "Váš košík je momentálně prázdný.",
          ...
          (e = [
            ...
            },
            {
              ...
              value: function (t) {
                ...
                if (t.item_count > 0) {
                  document.querySelector(".dont_have__items").style.display =
                    "none";

                  document.querySelector(".have__items").style.display =
                    "block";
                } else {
                  document.querySelector(".have__items").style.display = "none";
                  document.querySelector(".dont_have__items").style.display =
                    "block";
                }
              },
              ...
              value: function (t) {
                ...
                this.clearCartDrawer(),
                  t.items.forEach(function (t, r) {
                    ...
                    var v2 = a.split("|")[1];
                    if (v2 !== undefined) {
                      a = v1 + '<span class="variant-point"></span>' + v2;
                    } else {
                      a = v1;
                    }
                  ...
                  document.querySelectorAll(".freeShipMsg").forEach((msg) => {
                    let freeShipBar = $(".freeShipAmount").data("freeship");
                    let difference = (freeShipBar - t.total_price) / 100;
                    let cartValue = (t.total_price * 100) / freeShipBar;
                    if (freeShipBar <= t.total_price) {
                      msg.innerHTML = `
                            <i class="fas fa-shipping-fast"></i> Máte dopravu <span class="free-text">ZDARMA</span>! 
                        `;
                    } else if (freeShipBar > t.total_price) {
                      msg.innerHTML = `
            ...
            },
            {
              ...
              value: function () {
                ...
                return $.getJSON("/cart.js").then(function (cart) {
                  cartData = cart;
                  let freeShipBar = $(".freeShipAmount").data("freeship");
                  let difference = (freeShipBar - cart.total_price) / 100;
                  let cartValue = (cart.total_price * 100) / freeShipBar;

                  document.querySelectorAll(".freeShipMsg").forEach((msg) => {
                    if (freeShipBar <= cart.total_price) {
                      msg.innerHTML = `
                            <i class="fas fa-shipping-fast"></i> Máte dopravu <span class="free-text">ZDARMA</span>! 
                        `;
                    } else if (freeShipBar > t.total_price) {
