...
theme.MobileNav = (function () {
  ...
  function openMobileNav() {
    var translateHeaderHeight = cache.siteHeader.offsetHeight - 2;
...
// Digismoothie 1.1 customizations
// Sticky header
function headerSize() {
...
// digismoothie hide announcement bar after scrolling
document.addEventListener("DOMContentLoaded", function () {
  $(window).scroll(function () {
    if ($(window).scrollTop() > 10) {
      document.querySelector(".announcement-bar__message").style.display =
        "none";
    } else {
      document.querySelector(".announcement-bar__message").style.display =
        "block";
...
// let cartData;
// let totalPrice;
// let freeShipBar = 200000;
// function freeShip() {
//   $.getJSON("/cart.js", function (cart) {
//     cartData = cart;
//     let cartValue = cart.total_price;
//     document.querySelector(".freeShipMsg").innerHTML += `
//       ${cartValue}
//     `;
//   });
// }
